...
var util = require('util'),
    ...
    RawParser = require('./raw_parser').RawParser,
...
IncomingForm.prototype._parseContentType = function() {
  ...
  if (contentType.match(/octet-stream/i)) {
...
IncommingForm.prototype._initTextencoded = function () {
  this.type = "text";
  ...
  parser.onEnd = function(buffer) {
    self.emit('raw', buffer);
    self.ended = true;
    self._maybeEnd();
  }
  this._parser = parser;
